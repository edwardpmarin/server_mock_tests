...
{
    public class ExampleWithStubHttp : IDisposable
    {
        private readonly FluentMockServer stub;
        private readonly string baseUrl;
        private readonly HttpClient _client;
        public ExampleWithStubHttp(HttpClient client)
        {
            _client = client;
        ...
        public async Task TestAsync()
        {
            ...
            var response = await _client.PatchAsync($"media/test/Complete", null);
